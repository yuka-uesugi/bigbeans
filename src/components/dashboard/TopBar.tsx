        ...
        <div className="relative">
          {user ? (
            ...
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 bg-white border border-ag-gray-200 rounded-xl text-sm font-bold text-ag-gray-700 hover:bg-ag-gray-50 hover:border-ag-gray-300 transition-all shadow-sm active:scale-95 cursor-pointer"
            >
