          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div className="bg-white/80 backdrop-blur-sm border-2 border-ag-lime-200 rounded-3xl p-6 text-left shadow-sm hover:shadow-md hover:border-ag-lime-400 transition-all group">
              ...
              <button
                ...
                disabled={signingIn}
                className="w-full flex items-center justify-center gap-2 px-5 py-3 bg-ag-lime-500 text-white rounded-2xl font-black shadow-md shadow-ag-lime-500/20 hover:bg-ag-lime-600 hover:scale-[1.02] transition-all active:scale-95 text-sm disabled:opacity-60 disabled:cursor-not-allowed disabled:hover:scale-100"
              >
                {signingIn ? (
                  <>
