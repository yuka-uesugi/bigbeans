        ...
        {activeTab === "fees" && (
          <div className="space-y-8 animate-fade-in">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
              {[
                { icon: "INFO", title: "1年ごとの更新制度", text: "毎年、秋大会が終わる頃（11月中旬）に、来年度の継続（更新）の意思確認をいたします。マイページから申請できます。この時期に確認するのは、来年度の役員の引き継ぎ期間を十分に確保するためでもあります。" },
                { icon: "RULE", title: "ライト会員", text: "介護・仕事・療養などの理由で、毎週の参加が難しいメンバーの区分です。「毎週の参加が厳しいから辞める・入部をあきらめる」という決断を防ぎ、自分のペースで細く長く続けられる環境を整えました。本来は毎回参加が基本ですが、時代背景や部の繁栄を考慮し、幅広く仲間を募る方針による制度です。誰でもなれるわけではなく、現メンバーの60%以上の賛同が必要です。「申請管理」から月末までに申請し、承認されると翌月から適用されます。" },
                { icon: "RULE", title: "数ヶ月お休みするとき", text: "1年ごとの登録制度のため、従来の「休部」という区分はありません。正規会員が怪我や家庭の事情などで数ヶ月お休みする場合は、ライト会員へ移動してください。お休み中もリハビリなどで練習に参加したいときはライトの料金で参加でき、見学や基礎打ちだけなら無料です。復帰して正規会員に戻ることも、もちろん可能です。" }
              ].map((card, i) => (
