          ...
          <div className="space-y-8 animate-fade-in">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
              {[
                ...
                { icon: "RULE", title: "数ヶ月お休みするとき", text: "正規会員が怪我や家庭の事情などで数ヶ月お休みする場合は、ライト会員へ移動できます。「申請管理」から月末までに申請し、現メンバーの60%の賛同を得て承認されると、翌月から適用されます（会計の仕組みをシンプルにするため、切り替えは月単位です）。お休み中も、リハビリなどで練習に参加できそうなときはライトの料金で参加でき、見学や基礎打ちだけなら無料です。復帰して正規会員に戻ることももちろん可能で、柔軟に対応します。" },
